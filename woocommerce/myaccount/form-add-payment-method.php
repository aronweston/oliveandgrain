...
if ( $available_gateways ) : ?>
	<form id="add_payment_method" method="post">
		<h2><?php esc_html_e( 'Add Card Details', 'woocommerce' ); ?></h2>
		<div id="payment" class="woocommerce-Payment">
			...
			<div class="form-row">
				...
				<button type="submit" class="woocommerce-Button woocommerce-Button--alt formButton" id="place_order" value="<?php esc_attr_e( 'Add payment method', 'woocommerce' ); ?>"><?php esc_html_e( 'Add payment method', 'woocommerce' ); ?></button>
